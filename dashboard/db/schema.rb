...
ActiveRecord::Schema.define(version: 20150406193626) do
  ...
  create_table "scripts", force: :cascade do |t|
    ...
    t.boolean  "trophies",        limit: 1,   default: false, null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean  "prize_earned",               limit: 1,     default: false
    t.integer  "prize_id",                   limit: 4
    t.boolean  "teacher_prize_earned",       limit: 1,     default: false
    t.integer  "teacher_prize_id",           limit: 4
    t.boolean  "teacher_bonus_prize_earned", limit: 1,     default: false
